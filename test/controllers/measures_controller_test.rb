...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { bssid: @measure.bssid, point_id: @measure.point_id, rssi: @measure.rssi, ssid: @measure.ssid } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { bssid: @measure.bssid, point_id: @measure.point_id, rssi: @measure.rssi, ssid: @measure.ssid } }
    assert_response 200
  end
